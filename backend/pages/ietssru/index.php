<?php
    ...
    $folderPathpictures = "../../../assets/pictures/ietssru";
    $folderPathvideos = "../../../assets/videos/ietssru";
    $folderPath3dmodels = "../../../assets/3dmodels/ietssru";
...
<head>
  ...
  <title>IETSSRU | Admin FIT SSRU</title>
            ...
            <div class="container-fluid">
                <div class="small-box py-3 bg-white shadow">
                    <div class="inner text-center">
                        <h3>เทคโนโลยีไฟฟ้า</h3>
                        <p class="text-danger">Electrical Technology</p>
                    </div>
                    <div class="icon">
                ...
                <div class="row">
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-info shadow">
                            ...
                            <a href="../3dmodels?page=ietssru" class="small-box-footer py-3"> คลิกจัดการระบบ <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-primary shadow">
                            ...
                            <a href="../pictures?page=ietssru" class="small-box-footer py-3"> คลิกจัดการระบบ <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-success shadow">
                            ...
                            <a href="../videos?page=ietssru" class="small-box-footer py-3"> คลิกจัดการระบบ <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-danger shadow">
                            ...
                            <a href="../comments?page=ietssru" class="small-box-footer py-3"> คลิกจัดการระบบ <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-3">
                        <div class="small-box py-3 bg-white shadow">
                            <div class="inner">
                                <?php     
                                    $params = array('branch_name' => 'ietssru', 'category' => '3dmodel');
                    ...
                    <div class="col-lg-3">
                        <div class="small-box py-3 bg-white shadow">
                            <div class="inner">
                                <?php     
                                    $params = array('branch_name' => 'ietssru', 'category' => 'picture');
                    ...
                    <div class="col-lg-3">
                        <div class="small-box py-3 bg-white shadow">
                            <div class="inner">
                                <?php     
                                    $params = array('branch_name' => 'ietssru', 'category' => 'video');
                    ...
                    <div class="col-lg-3">
                        <div class="small-box py-3 bg-white shadow">
                            <div class="inner">
                                <?php     
                                    $params = array('branch_name' => 'ietssru');
