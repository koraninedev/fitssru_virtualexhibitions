<?php
    ...
    $folderPathpictures = "../../../assets/pictures/stohssru";
    $folderPathvideos = "../../../assets/videos/stohssru";
    $folderPath3dmodels = "../../../assets/3dmodels/stohssru";
...
<head>
  ...
  <title>STOHSSRU | Admin FIT SSRU</title>
            ...
            <div class="container-fluid">
                <div class="small-box py-3 bg-white shadow">
                    <div class="inner text-center">
                        <h3>เทคโนโลยีความปลอดภัยและอาชีวอนามัย</h3>
                        <p class="text-danger">Safety Technology and Occupational Health</p>
                    </div>
                    <div class="icon">
                ...
                <div class="row">
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-info shadow">
                            ...
                            <a href="../3dmodels?page=stohssru" class="small-box-footer py-3"> คลิกจัดการระบบ <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-primary shadow">
                            ...
                            <a href="../pictures?page=stohssru" class="small-box-footer py-3"> คลิกจัดการระบบ <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-success shadow">
                            ...
                            <a href="../videos?page=stohssru" class="small-box-footer py-3"> คลิกจัดการระบบ <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-danger shadow">
                            ...
                            <a href="../comments?page=stohssru" class="small-box-footer py-3"> คลิกจัดการระบบ <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-3">
                        <div class="small-box py-3 bg-white shadow">
                            <div class="inner">
                                <?php     
                                    $params = array('branch_name' => 'stohssru', 'category' => '3dmodel');
                    ...
                    <div class="col-lg-3">
                        <div class="small-box py-3 bg-white shadow">
                            <div class="inner">
                                <?php     
                                    $params = array('branch_name' => 'stohssru', 'category' => 'picture');
                    ...
                    <div class="col-lg-3">
                        <div class="small-box py-3 bg-white shadow">
                            <div class="inner">
                                <?php     
                                    $params = array('branch_name' => 'stohssru', 'category' => 'video');
                    ...
                    <div class="col-lg-3">
                        <div class="small-box py-3 bg-white shadow">
                            <div class="inner">
                                <?php     
                                    $params = array('branch_name' => 'stohssru');
