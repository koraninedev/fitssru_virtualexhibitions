...
<head>
  ...
  <title>จัดการบทความ 3D Models | Admin FIT SSRU</title>
...
<script>
    $(function() {
        ...
        $.ajax({
            ...
            data.response.forEach(function (item, index){
                ...
                tableData.push([    
                    ...
                    `<img src="../../../assets/3dmodels/${branchName}/thumbnails/${item.image}" width="150px" height="90px" style="object-fit: cover;">`,
                    `${item.subject}`,
                    `${item.subtitle}`,
        ...
        $(document).on('change', '.toggle-event', function() {
            ...
            $.ajax({
                type: "PUT",
                url: "../../service/3dmodels/update_status.php",
                data: JSON.stringify({
                    blog_id: blogId,
        ...
        function initDataTables(tableData) {
            $('#logs').DataTable( {
                ...
                columns: [
                    ...
                    { title: "โมเดล" , className: "align-middle"},
                ...
                fnDrawCallback: function() {
                    ...
                    /* $('.toggle-event').each(function() {
                        const blogStatus = $(this).data('blog-status');
                        $(this).prop('checked', blogStatus === 'true');
                    })    */
                },
                responsive: {
                    details: {
