<?php
    ...
    $folderPathpictures = "../../../assets/pictures/real-fmssru";
    $folderPathvideos = "../../../assets/videos/real-fmssru";
    $folderPath3dmodels = "../../../assets/3dmodels/real-fmssru";
...
<head>
  ...
  <title>REAL-FMSSRU | Admin FIT SSRU</title>
            ...
            <div class="container-fluid">
                <div class="small-box py-3 bg-white shadow">
                    <div class="inner text-center">
                        <h3>การจัดการอสังหาริมทรัพย์และทรัพยากรอาคาร</h3>
                        <p class="text-danger">Real Estate and Facility Management</p>
                    </div>
                    <div class="icon">
                ...
                <div class="row">
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-info shadow">
                            ...
                            <a href="../3dmodels?page=real-fmssru" class="small-box-footer py-3"> คลิกจัดการระบบ <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-primary shadow">
                            ...
                            <a href="../pictures?page=real-fmssru" class="small-box-footer py-3"> คลิกจัดการระบบ <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-success shadow">
                            ...
                            <a href="../videos?page=real-fmssru" class="small-box-footer py-3"> คลิกจัดการระบบ <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-danger shadow">
                            ...
                            <a href="../comments?page=real-fmssru" class="small-box-footer py-3"> คลิกจัดการระบบ <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-3">
                        <div class="small-box py-3 bg-white shadow">
                            <div class="inner">
                                <?php     
                                    $params = array('branch_name' => 'real-fmssru', 'category' => '3dmodel');
                    ...
                    <div class="col-lg-3">
                        <div class="small-box py-3 bg-white shadow">
                            <div class="inner">
                                <?php     
                                    $params = array('branch_name' => 'real-fmssru', 'category' => 'picture');
                    ...
                    <div class="col-lg-3">
                        <div class="small-box py-3 bg-white shadow">
                            <div class="inner">
                                <?php     
                                    $params = array('branch_name' => 'real-fmssru', 'category' => 'video');
                    ...
                    <div class="col-lg-3">
                        <div class="small-box py-3 bg-white shadow">
                            <div class="inner">
                                <?php     
                                    $params = array('branch_name' => 'real-fmssru');
