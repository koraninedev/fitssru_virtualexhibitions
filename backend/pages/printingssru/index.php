<?php
    ...
    $folderPathpictures = "../../../assets/pictures/printingssru";
    $folderPathvideos = "../../../assets/videos/printingssru";
    $folderPath3dmodels = "../../../assets/3dmodels/printingssru";
...
<head>
  ...
  <title>PRINTINGSSRU | Admin FIT SSRU</title>
            ...
            <div class="container-fluid">
                <div class="small-box py-3 bg-white shadow">
                    <div class="inner text-center">
                        <h3>อุตสาหกรรมศิลป์และวิทยาศาสตร์</h3>
                        <p class="text-danger">Industrial Arts and Science</p>
                    </div>
                    <div class="icon">
                ...
                <div class="row">
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-info shadow">
                            ...
                            <a href="../3dmodels?page=printingssru" class="small-box-footer py-3"> คลิกจัดการระบบ <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-primary shadow">
                            ...
                            <a href="../pictures?page=printingssru" class="small-box-footer py-3"> คลิกจัดการระบบ <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-success shadow">
                            ...
                            <a href="../videos?page=printingssru" class="small-box-footer py-3"> คลิกจัดการระบบ <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-danger shadow">
                            ...
                            <a href="../comments?page=printingssru" class="small-box-footer py-3"> คลิกจัดการระบบ <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-3">
                        <div class="small-box py-3 bg-white shadow">
                            <div class="inner">
                                <?php     
                                    $params = array('branch_name' => 'printingssru', 'category' => '3dmodel');
                    ...
                    <div class="col-lg-3">
                        <div class="small-box py-3 bg-white shadow">
                            <div class="inner">
                                <?php     
                                    $params = array('branch_name' => 'printingssru', 'category' => 'picture');
                    ...
                    <div class="col-lg-3">
                        <div class="small-box py-3 bg-white shadow">
                            <div class="inner">
                                <?php     
                                    $params = array('branch_name' => 'printingssru', 'category' => 'video');
                    ...
                    <div class="col-lg-3">
                        <div class="small-box py-3 bg-white shadow">
                            <div class="inner">
                                <?php     
                                    $params = array('branch_name' => 'printingssru');
